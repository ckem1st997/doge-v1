...
namespace ConsoleApp3
{
    internal class Program
    {
        ...
        private static HashSet<string> dataCheck = new HashSet<string>();
        ...
        static async Task Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    var keyPath = new KeyPath("m/44'/3'/0'/0/0"); // Đường dẫn BIP44 cho Dogecoin
            ...
            async Task<bool> AddressExistsInCsv(List<string> listAddress, string csvFilePath)
            {
                ...
                //await Parallel.ForEachAsync(listAddress, new ParallelOptions { CancellationToken = cts.Token }, async (item, cancellationtoken) =>
                //{
                //    if (addData.Contains(item))
                //    {
                //        addressfound = true;
                //        cts.Cancel();
                //    }
